...
export default function HomeView({ onNavigate }: HomeViewProps) {
  ...
  const sampleTestimonials: Testimonial[] = [
    {
      ...
      text: 'Our garage door spring snapped loud like a gunshot at 6:00 AM on a Tuesday near WKU campus, trapping both of our cars inside. I called Bowling Green Garage Door Repair and their technician, Brad, arrived by 7:15 AM! He replaced both springs, balanced the door, and had us rolling in less than an hour. Exceptional same-day response and honest upfront pricing!'
    },
    {
      id: '2',
      name: 'Jessica L.',
    ...
    },
    {
      ...
      text: 'The curb appeal boost on our house in Cumberland Ridge is incredible. They helped us choose an insulated carriage-style door that matches our home perfectly. Not only does it look amazing, but our garage is noticeably warmer and draft-free now. Upfront pricing, quick clean install, and zero high-pressure sales pitches.'
    },
    {
      id: '6',
      name: 'James T.',
  ...
  return (
    <div className="w-full bg-slate-50 font-sans">
      ...
      <section className="relative bg-slate-900 py-12 lg:py-20 overflow-hidden text-white min-h-[600px] flex items-center">
        ...
        <div className="absolute inset-0 z-0 select-none pointer-events-none opacity-40">
          <img
            ...
            alt="Premium Garage Door in Bowling Green KY"
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-left">
            <span className="inline-block text-xs md:text-sm font-black text-amber-400 uppercase tracking-widest bg-amber-950/60 px-3 py-1.5 rounded-full border border-amber-800/40 w-fit">
              ★ Same-Day Service in Bowling Green & South Central KY ★
            </span>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tight leading-tight md:leading-none text-slate-100">
              Fast & Reliable Garage Door Repair in <span className="text-amber-400">Bowling Green, KY</span>
            </h2>
            <p className="text-sm md:text-lg text-slate-200 leading-relaxed max-w-xl">
              Broken springs? Noisy opener? Stuck door? Get fully certified, local professionals at your door today. We specialize in fast-response repairs and premium installations across Warren County.
            </p>
      ...
      <section className="py-16 md:py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-sm md:text-base mt-4 leading-relaxed">
              We take immense pride in our workmanship. See what our local customers in Bowling Green, Smiths Grove, Alvaton, and surrounding South Central Kentucky are saying about our rapid service.
            </p>
          </div>
      ...
      {/* Contact Callout & Dynamic Google Map Section */}
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-5 text-left">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">
            Serving Bowling Green, KY & Surrounding Communities
          </h2>
          <p className="text-slate-600 text-sm md:text-base leading-relaxed">
            We are centrally located in Bowling Green, allowing our emergency repair vehicles to reach nearby Smiths Grove, Oakland, Alvaton, Woodburn, Rockfield, Franklin, Scottsville, and Glasgow within approximately 45-60 minutes.
          </p>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex flex-col gap-4 mt-2">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-slate-500 block mt-0.5">120 E Main Ave, Bowling Green, KY 42101</span>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="tel:3642018889" className="text-xs font-bold text-blue-950 block mt-0.5 hover:text-amber-500 transition-colors">
                  364-201-8889
                </a>
              </div>
            </div>
        ...
        {/* Right Column (Secure Google Map Iframe representing Bowling Green, KY) */}
        <div className="bg-white border border-slate-200 rounded-3xl p-3 shadow-md h-[380px] overflow-hidden relative">
          <iframe
            title="Google Map Bowling Green KY"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d50821.28286940843!2d-86.47683935!3d36.9903125!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8865e2195f2a149b%3A0xc3b8a1c9df25bf51!2sBowling%20Green%2C%20KY!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus"
            width="100%"
            height="100%"
