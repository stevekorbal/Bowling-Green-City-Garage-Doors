...
export default function FaqView({ onNavigate }: { onNavigate: (path: string) => void }) {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'This is almost always a safety sensor alignment issue. Federal law requires automatic openers to feature optical safety photo-eyes. If the beam is blocked by debris (cobwebs, trash cans, toys), if one sensor is misaligned, or if there is a loose connection in the wire, the opener assumes an obstacle is in the path and will reverse the door, flashing its light bulbs to alert you.'
    },
    {
      id: 'f6',
      category: 'openers',
      question: 'What is the lifespan of a typical automatic garage door opener?',
      answer: 'On average, a quality automatic opener lasts between 10 and 15 years. Regular maintenance (checking balance, keeping gears lubricated) can push it closer to 20 years. If your opener has seized motor windings or is an obsolete pre-1993 model lacking safety photo-eyes, immediate replacement is highly recommended.'
    },
    {
      id: 'f7',
      category: 'emergency',
    ...
    },
    {
      id: 'f8',
      category: 'emergency',
      question: 'How fast do you respond to emergency repair calls in Bowling Green?',
      answer: 'Our local dispatch operators coordinate emergency responses in Bowling Green and surrounding Warren County (Smiths Grove, Alvaton, Franklin) 24/7/365. On average, we have a fully stocked service vehicle and certified technician on your property within 45 to 60 minutes of your call.'
    },
    {
      id: 'f9',
        ...
        <div className="bg-blue-900 text-white rounded-3xl p-8 mt-12 flex flex-col md:flex-row justify-between items-center gap-6 shadow-md text-left">
          <div>
            ...
            <p className="text-blue-200 text-xs md:text-sm mt-1 leading-relaxed">
              Don't risk structural or bodily damage. Our local Bowling Green experts are ready to diagnose and repair your system right now.
            </p>
          </div>
          <a
            href="tel:3642018889"
