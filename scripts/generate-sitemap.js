...
function getDomainFromEnv() {
  ...
  if (!domain) {
    domain = (process.env.APP_URL && process.env.APP_URL !== 'MY_APP_URL')
      ? process.env.APP_URL
      : 'https://www.garagedoorrepairbowlinggreenky.com';
  }
...
const staticPages = [
  ...
  { loc: '/city/bowling-green-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/smiths-grove-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/oakland-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/alvaton-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/plum-springs-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/woodburn-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/rockfield-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/auburn-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/franklin-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/scottsville-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/brownsville-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/glasgow-ky', changefreq: 'weekly', priority: '0.8' },
  { loc: '/city/morgantown-ky', changefreq: 'weekly', priority: '0.8' },
